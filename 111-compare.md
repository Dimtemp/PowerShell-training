...
1. Now start any new process. For example: start Microsoft Paint, or start the calculator.
1. Run this command to perform a comparison of the current process listing with the stored process listing in memory: ```Compare-Object $p (get-process) -Property Name```
